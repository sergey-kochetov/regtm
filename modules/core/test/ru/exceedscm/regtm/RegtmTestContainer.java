...
public class RegtmTestContainer extends TestContainer {

    public RegtmTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/exceedscm/regtm/app.properties",
    ...
    public static class Common extends RegtmTestContainer {

        public static final RegtmTestContainer.Common INSTANCE = new RegtmTestContainer.Common();
